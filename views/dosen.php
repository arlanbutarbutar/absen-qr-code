              ...
              <div class="card-body text-center">
                ...
                <form action="" method="post">
                  <div class="mb-3 mt-4">
                    ...
                    <input type="number" name="nidn" class="form-control" id="nidn" placeholder="NIP" required>
                  </div>
                  <div class="mb-3">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form action="" method="post">
                                      <div class="modal-body text-center">
                                        <div class="mb-3 mt-4">
                                          <label for="nidn" class="form-label">NIP</label>
                                          <input type="number" name="nidn" value="<?= $row['nip_dosen'] ?>" class="form-control" id="nidn" placeholder="NIP" required>
                                        </div>
                                        <div class="mb-3">
                                          <label for="nama" class="form-label">Nama Dosen</label>
